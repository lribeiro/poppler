...
static const ArgDesc argDesc[] = { { "-f", argInt, &firstPage, 0, "first page to convert" },
                                   ...
                                   { "-bbox", argFlag, &bbox, 0, "output bounding box for each word and page size to html." },
                                   { "-bbox-layout", argFlag, &bboxLayout, 0, "like -bbox but with extra layout bounding box data." },
